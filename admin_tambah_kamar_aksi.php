...
if(ISSET($_POST['submit'])){
	if($_FILES['upload']['name'] != "") {
        ...
        $query = mysqli_query($con, "SELECT max(idKamar) as kodeTerbesar FROM tbtypekamar");
		...
		mysqli_query($con,"insert into tbtypekamar values('$no','$nama','$jumlah','$name[0]','$path','$fasilitas')");
