...
<div class="formtgl">
    <form action="admin_tambah_kamar_aksi.php" method="POST" enctype="multipart/form-data">
    <table  >
                     <tr>
                                <td> <h1>Tambah Type Kamar</h1></td>
                                ...
                                <td><input type="text" class="validate[required]" id="date" name="jumlah"></td>
                                </tr>
                                <tr>
                                ...
                                <td><input type="text" class="validate[required]" id="date" name="fasilitas"></td>
                                </tr>
                    </tr>
