...
while($row= mysqli_fetch_array($sql)) {
       ...
       <tr>
        ...
        <td><a href="admin_fasilitas_edit.php?del=<?php echo $row['idFasilitas']?>">EDIT</a></td>
        <td><a href="admin_fasilitas_delete.php?del=<?php echo $row['idFasilitas']?>">DELETE</a></td>
...
<a href="admin_tambah_fasilitas.php"><img src="pngwing.com (2).png" height="10%" width="10%" style="margin-left:675px" alt=""></a>
